...
//
// The power profile is specified by a matrix P containing power samples and a
// vector ΔT assigning durations to each of the samples.
func (self *Fluid) Compute(P, ΔT []float64) []float64 {
